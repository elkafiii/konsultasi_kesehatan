...
<h3 style="text-align: center;" class="blue-text">Sign Up!</h3>
<br><center><p> Konsultasi Kesehatan </p></center>
...
<?php 
	if(isset($_POST['login'])){
		...
		$sql = mysqli_query($koneksi,"SELECT * FROM pasien WHERE username='$username' AND password='$password' ");
		...
		elseif($cek2>0){
			...
			echo "<script>alert('Gagal Login silakan coba lagi')</script>";
		}
