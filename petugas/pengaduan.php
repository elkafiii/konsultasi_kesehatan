        <div class="row">
          <div class="col s12 m9">
            <h3 class="blue-text">Pengaduan</h3>
          </div>
        </div>
	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN pasien ON pengaduan.nik=pasien.nik WHERE pengaduan.status='proses' ORDER BY pengaduan.id_pengaduan DESC");
